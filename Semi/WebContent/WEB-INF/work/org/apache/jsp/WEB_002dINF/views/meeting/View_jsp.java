 ...
 * Generated at: 2021-04-22 08:34:46 UTC
...
if(msg!=null){
 ...
 if(m.getTime().getTime()< new java.util.Date().getTime()
      ...
      out.write("\r\n");
      out.write("\t\t\t<input type=\"button\" value=\"마감\" class=\"meetingViewBtn\"/>\r\n");
      out.write("\t\t\t");
}else if(loginMember!=null && list.contains(loginMember.getMemberId())){ 
      out.write("\r\n");
      out.write("\t\t\t<input type=\"button\" value=\"취소\" class=\"meetingViewBtn\" onclick=\"cancel();\"/>\r\n");
      out.write("\t\t\t");
}else{ 
      out.write("\r\n");
      out.write("\t\t\t<input type=\"button\" value=\"신청\" class=\"meetingViewBtn\" onclick=\"apply();\"/>\r\n");
      out.write("\t\t\t");
} 
      out.write("\r\n");
      out.write("\t\t</div>\r\n");
